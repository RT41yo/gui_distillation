...
class Gui2MCPAgent:
    ...
    def run_episode(
        ...
        store = ArtifactStore(self._base_output_dir, "pending")
        # Use the UUID generated by EpisodeRecordBuilder — swap store after we know it
        # Workaround: pre-generate UUID via a builder probe
